...
if (result.success) {
    ...
    document.getElementById("successName").innerHTML =
        "الأستاذ/ة <strong>" + data.name + "</strong>";
const svg = document.querySelector(".check-mark");
...
if(svg){
    ...
    // إخفاء الفورم بالكامل
    document.getElementById("rsvpForm").style.display = "none";

    // إخفاء العنوان والوصف أيضاً
...
if(downloadBtn){
    ...
    downloadBtn.onclick = async ()=>{
        ...
        link.download = "Wedding-Confirmation.png";
